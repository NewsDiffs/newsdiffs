...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.migrated_article_id'
        db.add_column('Articles', 'migrated_article_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.migrated_article_id'
        db.delete_column('Articles', 'migrated_article_id')
    ...
    models = {
        u'frontend.article': {
            ...
            'migrated_article_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'null': 'True'}),
